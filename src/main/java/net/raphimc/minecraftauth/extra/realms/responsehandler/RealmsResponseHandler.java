 ...
 */
package net.raphimc.minecraftauth.extra.realms.responsehandler;
...
public interface RealmsResponseHandler<R> extends JsonHttpResponseHandler<R> {
    ...
    default void handleError(final HttpResponse response, final GsonObject json) throws IOException {
        if (json.hasNumber("errorCode") && json.hasString("errorMsg")) {
            throw new RealmsRequestException(response, json.reqInt("errorCode"), json.reqString("errorMsg"));
        }
    }
