...
public class JavaRealmsTosAgreedRequest extends PostRequest implements RealmsResponseHandler<Void> {

    public JavaRealmsTosAgreedRequest() throws MalformedURLException {
